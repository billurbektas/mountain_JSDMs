...
pdf(here("Calanda_JSDM", "plot", "detailed_modeling_experiment_figures", "exp1_convergence.pdf"),
    width = 10, height = 6)
print(p_conv)
dev.off()
...
pdf(here("Calanda_JSDM", "plot", "detailed_modeling_experiment_figures", "exp1_species_violins.pdf"),
    width = 14, height = 8)
print(p_species)
dev.off()
...
pdf(here("Calanda_JSDM", "plot", "detailed_modeling_experiment_figures", "exp1_sites_violins.pdf"),
    width = 14, height = 8)
print(p_sites)
dev.off()
...
pdf(here("Calanda_JSDM", "plot", "detailed_modeling_experiment_figures", "exp1_anova_R2.pdf"),
    width = 14, height = 8)
print(p_anova)
dev.off()
